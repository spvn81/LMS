...
class userController extends Controller
{
    ...
    function send_otp(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($data[0]->email == $email) {
                ...
                $data_otp->save();
                return response()->json(['success' => 'Otp has sent to your email Id.']);
            } else {
    ...
    public function register(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // }
            $save_data->addAllMediaFromTokens();
    ...
    function manage_user($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            $data['avatar'] = json_decode($data['user']->getMediaResource('avatars'));
    ...
    ->where(['video_libraries.user_id'=>auth::user()->id])
    ...
    ->get();
        ...
        return view('user.video.my_account', $data);
    }

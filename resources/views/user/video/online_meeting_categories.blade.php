...
<div class="container-fluid text-capitalize">
    <div class="video-block section-padding">
        <div class="row">
            ...
            @php
            $url =   regularModules::convertSlugIntoUrl($get_all_categories_data->categories_slug);
              @endphp

            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="category-item mt-0 mb-0">
                    <a href="{{ url('/categories/live/'.$url) }}">
                        ...
                        <h6>{{ $get_all_categories_data->categories }} <span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></h6>
